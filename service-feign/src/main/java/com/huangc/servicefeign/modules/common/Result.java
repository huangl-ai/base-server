package com.huangc.servicefeign.modules.common;
...
public class Result {
    ...
    public static final String REQUEST_TIME_OUT="服务调用超时！";
    ...
    public Result timeOut(){
        this.status = HttpStatus.REQUEST_TIMEOUT.value();
        this.message= REQUEST_TIME_OUT;
        return this;
    }
