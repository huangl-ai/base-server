 ...
 * @Description: 二叉树
 * https://juejin.im/post/5ab5a01d518825555c1d9a24#heading-10
 */
public class Test {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("树的深度："+getHeight(root.getTreeRoot()));

        System.out.println("最大值："+getMax(root.getTreeRoot()));
